...
export const styles = StyleSheet.create({
  ...
  stopModalActionsSecondary: {
    flexDirection: 'row',
    gap: 8,
  },
  stopModalActionsPrimary: {
    flexDirection: 'row',
    gap: 8,
  },
  stopModalBtn: {
