...
/**
 * Build the stop pins FeatureCollection with per-feature `label` + `color`,
    ...
    features: (stops || [])
      ...
      .map((s) => {
        ...
        return {
          ...
          id: s.id,
          properties: { id: s.id, label, color, completed },
    ...
    return (
      ...
      >
        ...
        >
          ...
          {/* Delivery stops: numbered pins. When cluster data is present they
